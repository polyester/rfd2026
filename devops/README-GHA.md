...
2. Go to your repository at [polyester/rfd2026](https://github.com/polyester/rfd2026).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `rozefilmdagen.nl` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | rozefilmdagen.nl | The hostname or IP address of your Docker Swarm manager. |
...
- [Backend Tests Workflow](https://github.com/polyester/rfd2026/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/polyester/rfd2026/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/polyester/rfd2026-backend`) and Frontend (`ghcr.io/polyester/rfd2026-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of rozefilmdagen.nl](https://github.com/polyester/rfd2026/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/rozefilmdagen.nl.yml` stack.
